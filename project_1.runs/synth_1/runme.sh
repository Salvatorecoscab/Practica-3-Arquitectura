...
HD_PWD='C:/Users/Salvadorcoscab/Documents/vhdlPracticas/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aluP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aluP.tcl
