...
HD_PWD='Z:/Projects/VivadoProjects/Practica3/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compn.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source compn.tcl
